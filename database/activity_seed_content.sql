INSERT INTO `club_activities` (
  `title`, `slug`, `activity_date`, `description`, `content`, `cover_image`, `gallery_images`, `registration_link`
) VALUES
...
It was inspiring to see everyone move from understanding basic logic to understanding how devices talk with each other. Great energy from everyone involved!', 'Communication Protocols UART and HTTP-1.jpg', 'Communication Protocols UART and HTTP-1.jpg|Communication Protocols UART and HTTP-2.jpg|Communication Protocols UART and HTTP-3.jpg', NULL),
...
It was the beginning of an exciting learning journey in embedded systems.

Registration is still open for 2k24, so come and grab your seat.', 'Workshop on HACK Club Robotics-1.jpg', 'Workshop on HACK Club Robotics-1.jpg|Workshop on HACK Club & Robotics-2.jpg|Workshop on HACK Club & Robotics-3.jpg|Workshop on HACK Club & Robotics-4.jpg|Workshop on HACK Club & Robotics-5.jpg|Workshop on HACK Club & Robotics-6.jpg', 'https://docs.google.com/'),
...
Excited for what is coming next.', 'LFR-workshop-1.jpg', 'LFR-workshop-1.jpg|LFR-workshop-2.jpg|LFR-workshop-3jpg.jpg', NULL),
...
Thanks to everyone who joined and made the session successful.', 'MPU6050 with Arduino and Python-1.jpg', 'MPU6050 with Arduino and Python-1.jpg|MPU6050 with Arduino and Python-2.jpg|MPU6050 with Arduino and Python-3.jpg', NULL),
...
A heartfelt thanks to everyone who joined the session. We are truly glad to have such impressive and dedicated juniors. Your enthusiasm made it a success!', 'Session on Servo Motor and LDR-1.jpg', 'Session on Servo Motor and LDR-1.jpg|Session on Servo Motor and LDR-2.jpg|Session on Servo Motor and LDR-3.jpg|Session on Servo Motor and LDR-4.jpg|Session on Servo Motor and LDR-5.jpg', NULL),
...
We will be back with more sessions soon, so stay tuned. Until then, keep learning and keep building.', 'Basic Arduino, sensor interfacing, and serial communication-1.jpg', 'Basic Arduino, sensor interfacing, and serial communication-1.jpg|Basic Arduino, sensor interfacing, and serial communication-2.jpg|Basic Arduino, sensor interfacing, and serial communication-3.jpg|Basic Arduino, sensor interfacing, and serial communication-4.jpg|Basic Arduino, sensor interfacing, and serial communication-5.jpg|Basic Arduino, sensor interfacing, and serial communication-6.jpg', NULL),
...
Here are some glimpses of the moments.', 'Workshop on Servo motor-1.jpg', 'Workshop on Servo motor-1.jpg|Workshop on Servo motor-2.jpg|Workshop on Servo motor-3.jpg', NULL),
...
Together, we spark innovation, empower future tech leaders, and drive progress.', 'Spark Fusion-1.jpg', 'Spark Fusion-1.jpg|Spark Fusion-2.jpg|Spark Fusion-3.jpg|Spark Fusion-4.jpg', NULL)
